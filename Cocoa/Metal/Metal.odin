...
foreign metal {
   MTLCreateSystemDefaultDevice :: proc "c" () -> objc.id ---;
}

MTLPixelFormat :: enum u64 {
...
MTLCPUCacheMode :: enum u64 {
    DefaultCache  = 0,
    WriteCombined = 1,
};

MTLStorageMode :: enum u64 {
    Shared     = 0,
    Managed    = 1,
    Private    = 2,
    Memoryless = 3,
...
MTLHazardTrackingMode :: enum u64 {
    Default   = 0,
    Untracked = 1,
    Tracked   = 2,
};
...
MTLResourceOptions :: enum u64 {
    CPUCacheModeDefaultCache    = u64(MTLCPUCacheMode.DefaultCache)   << MTLResourceCPUCacheModeShift,
    CPUCacheModeWriteCombined   = u64(MTLCPUCacheMode.WriteCombined)  << MTLResourceCPUCacheModeShift,

    StorageModeShared           = u64(MTLStorageMode.Shared)          << MTLResourceStorageModeShift,
    StorageModeManaged          = u64(MTLStorageMode.Managed)         << MTLResourceStorageModeShift,
    StorageModePrivate          = u64(MTLStorageMode.Private)         << MTLResourceStorageModeShift,
    StorageModeMemoryless       = u64(MTLStorageMode.Memoryless)      << MTLResourceStorageModeShift,    
    
    HazardTrackingModeDefault   = u64(MTLHazardTrackingMode.Default)   << MTLResourceHazardTrackingModeShift,
    HazardTrackingModeUntracked = u64(MTLHazardTrackingMode.Untracked) << MTLResourceHazardTrackingModeShift,
    HazardTrackingModeTracked   = u64(MTLHazardTrackingMode.Tracked)   << MTLResourceHazardTrackingModeShift,
}
